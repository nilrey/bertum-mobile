...
public class CartActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String detail_article_orig ="", detail_article = "", detail_title = "", detail_title_rus = "", detail_type = "",
            detail_price = "";
    private ImageView smeta_tab_details, smeta_tab_repair,
            cart_tab_details, cart_tab_repair, detail_close_1, repair_close_1, repair_close_2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView ico_menu = findViewById(R.id.ico_menu);
        ...
        linkToSmetaDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(CartActivity.this, SmetaActivity.class));
            }
        });
...
//            detail_minprice_1 = findViewById(R.id.detail_minprice_1);
            ...
            detail_close_1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cart_warn_empty_order.setText(Html.fromHtml(Const.MSG_U_CANCEL_ALL + Const.MSG_SMETA_EMPTY));
            ...
            int cnt = 1;
            if(subDetailsAricles.size() > 0 ) rl_warn_subdetails.setVisibility(View.VISIBLE);
                ...
                detailClose.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        /* БВ в минутах делим на общее количество деталей необходимое по регламенту, получим пропорциональное время на каждую деталь
                         далее это Время детали умножаем на количество деталей оставшихся в списке, получим Актуальное Время на все доп. детали в списке*/
//                        double minutesRepairFinal = ((hoursSubDetails*60)/cntSubDetTotal)*cntSubDetCurrent; // + hoursDetail*60;
                ...
                btnBuy.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(CartActivity.this, "Деталь добавлена в корзину", Toast.LENGTH_SHORT).show();
            ...
            cart_total_details.setText( "У вас в корзине "+String.valueOf(getCountActiveSubDetails() + 1) + " запчастей");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        DataStore.setMenuItems(item, CartActivity.this);
        return true;
    }
        ...
        if(getSharedValueInt("cartSum") > 0 ) {
            for (int i = 2; i < 11; i++) {
                ...
                int detLayoutId = getResources().getIdentifier("rl_detail_" + String.valueOf(i),
                        "id", getPackageName());
                final RelativeLayout rl = findViewById(detLayoutId);
                if (subDetailVisible == 0) rl.setVisibility(View.GONE);
            ...
            // Recalculate total sum and repair work
            // получим стоимость из Глоб. переменной - общая цена Осн дет. + Сопутств
            //        int newTotalPrice = getSharedValueInt("cartSum") + DataStore.getPriceByArticleAvl(subArticleAvl);
            //        setSharedValueInt("cartSum", newTotalPrice );
...
//                    String link = payment_url.toString();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CartActivity.this, "Fail to get response..", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Nullable
            @Override
        ...
        Toast.makeText(CartActivity.this, "Данные успешно отправлены", Toast.LENGTH_SHORT).show();
